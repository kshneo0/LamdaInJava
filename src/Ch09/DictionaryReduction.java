...
public class DictionaryReduction {
	...
	private static final String FILE_PATH = "/Users/sanghoonkim/Documents/java/workspace/LamdaInJava/src/Ch08/dictionary.txt";
...
//							     	     .reduce(0, Math::max)
	...
	public static void sumTotalCharacters() throws IOException {
		...
		try(Stream<String> lines = Files.lines(Paths.get(FILE_PATH))){
			...
			int sum = lines.mapToInt(String::length)
						   .sum();
